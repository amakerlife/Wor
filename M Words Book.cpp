...
//	file.open("words.txt");
	/*--------------------------------------------------------------------------*/
			system("title M Words Book 单词本 v1.2.0 - 正在初始化");
			system("cls");
			cout<<"正在初始化 已完成 20%\n";
			system("echo off");
			...
			system("cls");
			cout<<"正在初始化 已完成 40%\n";
			system("copy .\\Lab120.a C:\\Users\\%USERNAME%\\AppData\\Roaming\\MWordsBook");
			system("cls");
			cout<<"正在初始化 已完成 60%\n";
			system("del .\\Lab120.a");
			system("cls");
			cout<<"正在初始化 已完成 80%\n";
			system("ren C:\\Users\\%USERNAME%\\AppData\\Roaming\\MWordsBook\\Lab120.a Lab120.exe");
			system("cls");
			cout<<"正在初始化 已完成 100%\n";
			system("cls");
	/*--------------------------------------------------------------------------*/
	memset(jieguo,1,sizeof(jieguo));
	system("title M Words Book 单词本 v1.2.0   By Makerlife");
